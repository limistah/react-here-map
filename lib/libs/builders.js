...
var _loadMap = _interopRequireDefault(require("./loadMap"));

var _initPlatform = _interopRequireDefault(require("./initPlatform"));
  ...
  var buildMap = function buildMap() {
    if (container && build) {
      ...
      (ret.createMap = _initMap.default),
        (ret.createPlatform = _initPlatform.default),
