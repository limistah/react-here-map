  ...
  function O(e) {
    ...
    return (
      ...
      new Promise(function(e, r) {
        ...
        h = {};
        return P(0), "prepare" === p && 0 === _ && 0 === b && S(), t;
      })
    );
    var t;
  }
  ...
  function E(t) {
    ...
    for (f in y)
      if (Object.prototype.hasOwnProperty.call(y, f) && (a = x[f]))
        for (R = y[f], i = 0; i < R.length; i++)
          (C = R[i]),
            (D = a.children.indexOf(C)) >= 0 && a.children.splice(D, 1);
    ...
    for (f in y)
      if (Object.prototype.hasOwnProperty.call(y, f) && (a = x[f])) {
        ...
        for (n = 0; n < R.length; n++)
          if (((C = R[n]), (r = a.hot._acceptedDependencies[C]))) {
  ...
  function(e, t, r) {
    (function(e, r) {
      ...
      var xe = ve(
          ...
          ? ve
          : function(e) {
              return $e(e) && T.call(e, "callee") && !X.call(e, "callee");
            },
        ke = Array.isArray;
      function Ae(e) {
        return null != e && Ce(e.length) && !Ie(e);
      }
      var De =
        Q ||
        function() {
...
*/ var n =
  ...
  function(e, t, r) {
    ...
    function f(e) {
      ...
      r || console.info("radius is not set, default radius of 1000 is used");
      var f = new H.map.Circle(i, r || 1e3, c);
      return (
        n.addObject(f),
        u && n.setCenter(i),
